...
CONTRACT_RELEASE_DIGEST: Final = 'sha256:c5dd4c39d1c69d07f8d8de3d1a09584bb906172fee2d5ac20ad25ff344b0db79'
...
class BudgetConsumption(TypedDict):
    apiVersion: JsonValue
    kind: Literal['BudgetConsumption']
    metadata: JsonValue
    spec: dict[str, JsonValue]
...
class ReplayRecord(TypedDict):
    apiVersion: JsonValue
    kind: Literal['ReplayRecord']
    metadata: JsonValue
    spec: dict[str, JsonValue]

class RuntimeAdmissionReceipt(TypedDict):
    apiVersion: JsonValue
    kind: Literal['RuntimeAdmissionReceipt']
    metadata: JsonValue
    payload: dict[str, JsonValue]
    signature: JsonValue

class RuntimeCommonSchemaApiVersion(TypedDict, total=False):
    pass

class RuntimeCommonSchemaBase64urlPublicKey(TypedDict, total=False):
    pass

class RuntimeCommonSchemaBase64urlSignature(TypedDict, total=False):
    pass

class RuntimeCommonSchemaBudgetLimits(TypedDict):
    maxConcurrentTasks: int
    maxModelTokens: int
    maxRetries: int
    maxTaskSeconds: int
...
class RuntimeCommonSchemaBudgetObserved(TypedDict):
    concurrentTasks: int
    modelTokens: int
    retries: int
    taskSeconds: int
...
class RuntimeCommonSchemaDenialReason(TypedDict, total=False):
    pass

class RuntimeCommonSchemaKeyPurpose(TypedDict, total=False):
    pass

class RuntimeCommonSchemaMetadata(TypedDict):
    id: JsonValue
    version: JsonValue

class RuntimeCommonSchemaNonce(TypedDict, total=False):
    pass

class RuntimeCommonSchemaSemver(TypedDict, total=False):
    pass

class RuntimeCommonSchemaSha256(TypedDict, total=False):
    pass

class RuntimeCommonSchemaSignature(TypedDict):
    algorithm: Literal['ED25519']
    keyId: JsonValue
    profile: Literal['RFC8785_JCS_ED25519_V1']
    purpose: JsonValue
    signedMessageDigest: JsonValue
    value: JsonValue

class RuntimeCommonSchemaStableId(TypedDict, total=False):
    pass

class RuntimeCommonSchemaTimestamp(TypedDict, total=False):
    pass

class RuntimeTrustBundle(TypedDict):
    apiVersion: JsonValue
    kind: Literal['RuntimeTrustBundle']
    metadata: JsonValue
    payload: dict[str, JsonValue]
    signature: JsonValue

class SignedAdmissionEnvelope(TypedDict):
    apiVersion: JsonValue
    kind: Literal['SignedAdmissionEnvelope']
    metadata: JsonValue
    payload: dict[str, JsonValue]
    signature: JsonValue
